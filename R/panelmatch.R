...
#' 
#' 
#' @param donnee a list of data frames, each one made up of at least two
#' qualitative variables (\emph{product}, \emph{panelist}) and a set of
#' quantitative variables (sensory descriptors)
#' @param col.p the position of the \emph{product} variable (in each data
#' frame, the same position)
#' @param col.j the position of the \emph{panelist} variable (in each data
#' frame, the same position)
#' @param firstvar the position of the first sensory descriptor (in each data
#' frame, the same position)
...
#' defined
#' @param hierar hierarchy in the variable (see \code{hmfa})
...
#' products: this matrix allows to find the product which are significatnly
#' different for the 2-components sensory description}
#' 
