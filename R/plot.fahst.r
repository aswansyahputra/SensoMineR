...
#' 
#' Plot the graphs for Factorial Approach for Hierarchical Sorting Task data
#' (FAHST).
#' 
#' 
#' @param x an object of class fahst
#' @param choix the graph to plot ("ind" for the products and the categories,
#' "group" for the consumers and "level" for the levels)
...
#' @param lab.lev boolean, if TRUE, the levels are labelled
...
#' products according to one of the levels of a consumer (give the number of
#' the colomn corresponding to the level)
#' @param habillage.lev give no color for the levels ("none"), color the levels
#' according to consumer ("subject") or color the levels according to the
#' number of the level ("level")
#' @param traj boolean, if TRUE, trajectories are drawn between levels of the
#' same consumer
...
#' levels factor map and the consumers factor map.
