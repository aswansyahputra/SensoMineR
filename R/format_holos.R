...
#' 
#' 
#' @param path.data The path corresponding to the folder containing all Holos
#' data (i.e. one folder per subject with different files: "X_comment.txt",
#' "X_data.txt", "X_last.txt", "X_txt").
#' @return A list of 4 objects: \code{IDsubjects}, a dataframe containing the
#' concordance between the names of the subjects as given in the Holos
...
#' verbalization data.
#' @seealso \code{\link{analyse_holos}}
#' @examples
#' 
#' \dontrun{
